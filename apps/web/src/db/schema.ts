...
export const AGENT_TYPES = ['claude-code', 'amp', 'codex'] as const
...
export const usageRecords = pgTable('usage_records', {
  ...
  return {
    ...
    uniqueDeviceDateAgentIdx: uniqueIndex('usage_records_unique_device_date_agent_idx').on(table.deviceId, table.date, table.agentType),
  }
})
